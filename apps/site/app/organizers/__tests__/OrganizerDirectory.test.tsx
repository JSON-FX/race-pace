...
const organizers: Organizer[] = [
  { id: "1", slug: "north", name: "Northern Crew", logoUrl: null, bannerUrl: null, description: "Bukidnon trail days", homeCity: "Malaybalay", homeProvince: "Bukidnon", homeRegion: "Northern Mindanao", homeBase: "Malaybalay, Bukidnon", raceTypes: [], events: [] },
  { id: "2", slug: "south", name: "Southern Crew", logoUrl: null, bannerUrl: null, description: null, homeCity: null, homeProvince: null, homeRegion: "Davao Region", homeBase: null, raceTypes: [], events: [] },
];
