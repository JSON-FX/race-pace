...
const rows: PaymentRow[] = [
  {
    refunded_amount: 0, processor_fee_cents: 0, processor_fee_source: "none", paid_at: null, registration_id: "r1", event_id: "ev-1", event_name: "Kitanglad Skyline Ultra", user_id: "u1",
