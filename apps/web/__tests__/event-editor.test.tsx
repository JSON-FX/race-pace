  ...
  mockUseEventForEditor.mockReturnValue({
    data: {
      event: {
        ...
        discipline: "trail", elevation_gain_m: null, cutoff_hours: null, start_lat: null, start_lng: null, finish_lat: null, finish_lng: null, route: null, description: null, hero_image_url: null, gallery: [], schedule: [], inclusions: [],
      },
      categories: [],
      addons: [],
    },
  ...
  mockUseEventForEditor.mockReturnValue({
    data: {
      event: {
        ...
        elevation_gain_m: null, cutoff_hours: null, start_lat: null, start_lng: null, finish_lat: null, finish_lng: null, route: null, description: null,
  ...
  mockUseEventForEditor.mockReturnValue({
    data: {
      event: {
        ...
        city_psgc_code: null, region_name: null, province_name: null, city_name: null, venue: null,
        event_date: null, end_date: null, flag_off: null, status: "open",
        discipline: "trail", elevation_gain_m: null, cutoff_hours: null, start_lat: null, start_lng: null, finish_lat: null, finish_lng: null, route: null, description: null, hero_image_url: null, gallery: [], schedule: [],
