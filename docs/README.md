...
Coming Soon events and separate paid reservations: [product and data contract](./specs/2026-09-25-coming-soon-events.md), [implementation plan](./plans/2026-09-25-coming-soon-events.md), [managed Passport plan](./plans/2026-09-25-coming-soon-managed-passports.md), and [release checklist](./operations/coming-soon-release.md). The approved runner Dossier prototype is in [the local preview](./previews/coming-soon-event/runner-options.html). Local application and database work is implemented on `codex/coming-soon-events`; one-place and two-Passport PayMongo sandbox checkouts passed on Docker. Staging rollout remains pending.
