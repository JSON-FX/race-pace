...
Coming Soon events and separate paid reservations: [product and data contract](./specs/2026-09-25-coming-soon-events.md), [implementation plan](./plans/2026-09-25-coming-soon-events.md), [managed Passport plan](./plans/2026-09-25-coming-soon-managed-passports.md), [event-capacity follow-up](./plans/2026-09-26-event-capacity-allocation.md), and [release checklist](./operations/coming-soon-release.md). The approved runner Dossier prototype is in [the local preview](./previews/coming-soon-event/runner-options.html). Coming Soon, managed-Passport payments, and the event-capacity correction are on staging. Remaining hosted acceptance is required before production promotion.
